...
//       // 创建新的 EventSource
//       const newEventSource = new EventSource('http://127.0.0.1:5000/stream_output', {
...
//             isConnected 
//               ? "bg-[var(--gray-9)] cursor-not-allowed" 
...
//       <div
//         ref={consoleRef}
//         className="flex-1 overflow-y-auto overflow-x-scroll bg-[var(--gray-2)] p-2 font-mono text-xs border border-red-500"
//       >
//         {logs.length === 0 && (
//           <p className="text-[var(--gray-11)]">暂无测试输出...</p>
//         )}
//         {logs.map((log) => {
