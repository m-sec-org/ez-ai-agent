...
from openai import (
    ...
    BadRequestError as OpenAIBadRequestError, base_url,
)
...
class OpenaiModels:
    ...
    async def send_openai_request(
        ...
        try:
            ...
            my_base_url = os.getenv("OPENAI_BASE_URL")
            if not my_base_url or my_base_url== "":
                client = AsyncOpenAI(api_key=api_key)
            else:
                client = AsyncOpenAI(api_key=api_key, base_url=my_base_url)
